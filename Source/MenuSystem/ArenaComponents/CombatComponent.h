...
public:
	...
	UFUNCTION(BlueprintCallable)
	void ShootBasketballFinished();

	UFUNCTION(BlueprintCallable)
	void LaunchBall();

	UFUNCTION(Server, Reliable)
	void ServerLaunchBall(const FVector_NetQuantize& Target);
...
protected:
	...
	TSubclassOf<class ABasketballProjectile> BasketballClass;

	void ShootBasketball();

	UFUNCTION(Server, Reliable)
	void ServerShootBasketball();
	...
	void ShowAttachedBall(bool bShowBall);
...
private:
	...
	UPROPERTY()
	class AArenaPlayerController* Controller;
	UPROPERTY()
	class AArenaHUD* HUD;
